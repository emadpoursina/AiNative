...
6. **Agent config** — symlink shared agents from AiNative per [personal-agents-symlinks.md](../../3.%20reference/setup/personal-agents-symlinks.md#new-project-setup); copy [ai-rules-template.md](../../2.%20ai-workflows/ai-rules-template.md) into `.cursor/rules/ai-rules.mdc`; fill in project context, stack, and out-of-scope items from the input doc
