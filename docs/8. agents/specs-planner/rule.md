...
- Before proposing new code: check library → in-repo reuse → build from scratch; document the choice in the execution plan — see [agentic-coding.md](../../2.%20ai-workflows/agentic-coding.md#plan)
