...
- Project rules live in `.cursor/rules/` (`engineering-os.mdc`, `ai-rules.mdc`, `Commit-style.mdc`)
...
- Feature planning (research → plan → implement): [cursor-plan/](../../2.%20ai-workflows/cursor-plan/)
