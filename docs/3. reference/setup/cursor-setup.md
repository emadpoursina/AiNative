...
- Feature planning (research → plan → implement): [specs-planner agent](../../8.%20agents/specs-planner/) — install with `npx specsmd@latest install`; use `/specsmd-fire-planner` then `/specsmd-fire-builder` under `.cursor/commands/`
