...
- Copy [ai-rules-template.md](../../2.%20ai-workflows/ai-rules-template.md) into `.cursor/rules/ai-rules.mdc` (Cursor) — project-specific; not symlinked
...
1. **Plan** — specs.md planner assesses complexity, runs interrogation (5 / 10 / 20 MCQs with recommended answers), then captures intent and breaks it into work items (include acceptance criteria, validation layer, and test flows)
